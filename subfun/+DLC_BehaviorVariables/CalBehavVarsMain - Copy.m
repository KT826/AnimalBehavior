function [ListBehavVars,DM,VEL,ACC,HE,HD,AHC,AHV,AHTD,...
    BH,IMM,LM,UnitName,Config_HE,Config_AHC,Config_IMM] = GetBehavVars_Save(body_center,PostProcessing,dlc_cutoff_smoothing,bin_ms,fps)
...
[AHC, UnitName.AHC, Config_AHC] = DLC_BehaviorVariables.AngularHeadChange(HD,bin_ms,Config_HE); %'degree-head angle change from bin_ms(default 200ms)';
%[AHV,UnitName.U_AHV] = DLC_BehaviorVariables.AngularHeadVelocity_Zong2022(HD,ts,fps); %'degree/sec'
[AHV,UnitName.U_AHV] = DLC_BehaviorVariables.AngularHeadVelocity(AHC,Config_AHC);
